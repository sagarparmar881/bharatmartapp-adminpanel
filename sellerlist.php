                ...
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard">
                        ...
                        <table class="table table-striped table-bordered dom-jQuery-events">
                            ...
                            <tbody>
                                <?php 
                                $sel = $con->query("select * from sellers_db");
                                $i=0;
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['o_accepted'];?></td>
                                    <td><?php echo $row['o_rejected'];?></td>
                                    <td><?php echo $row['o_delivered'];?></td>
                                    <td><?php echo $row['sales'];?></td>
                                    <td>
                  <a class="primary"  href="sellers.php?edit=<?php echo $row['id'];?>" data-original-title="" title="">
