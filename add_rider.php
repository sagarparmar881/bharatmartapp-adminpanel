...
<div class="row">
 	...
 	<div class="form-group">
								...
								<div class="form-group">
									<label for="cname">Select A Shop</label>
									<select name="shop_id" class="form-control" required>
									    <option value="">Select Shop</option>
									    <?php
									    $sr = $con->query("select * from category");
									    while($r = $sr->fetch_assoc())
									    {
									    ?>
   ...
   setTimeout(function()
	{
		window.location.href="add_rider.php";
						...
						{
$con->query("insert into rider(`name`,`mobile`,`email`,`aid`,`shop_id`,`status`,`address`,`password`)values('".$cname."','".$dcharge."','".$email."',".$area_id.",".$shop_id.",".$status.",'".$raddress."','".$password."')");
?>
