							...
							<div class="form-body">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group" style="visibility: hidden;">
									...
									<input type="text" id="gurl" class="form-control"  placeholder="Enter Seller Name" value="<?php echo $selk['sname'];?>" name="">	
								</div>

								<div class="form-group" style="visibility: hidden;">
											<label for="projectinput6">Select Seller</label>
											<select id="cat_change" name="sellerid" class="form-control">
												
												<?php 
												$j = mysqli_fetch_assoc(mysqli_query($con,"select * from sellers_db where id=".$selk['sellerid'].""));
												?>
												<option value="<?php echo $j['id'];?>"><?php echo $j['s_name'];?></option>
												<?php 
												$sk = mysqli_query($con,"select * from sellers_db where id !=".$selk['sellerid']."");
												while($h = mysqli_fetch_assoc($sk))
												{
												?>
												<option value="<?php echo $h['id'];?>"><?php echo $h['s_name'];?></option>
												<?php } ?>
								...
								<div class="form-group">
											<label for="projectinput6">Select Shop</label>
...
else 
{
	...
	$arr[] = "product/".$file_name;
        ...
        $con->query("update product set pname='".$pname."',pimg='".$pimg."',prel='".$related."',popular=".$popular.",discount=".$discount.",cid=".$catname.",sid=".$subcatname.",psdesc='".$psdesc."',pgms='".$pgms."',pprice='".$pprice."',status=".$status.",stock=".$ostock." where id=".$_GET['edit']."");
							...
							<div class="form-body">
								...
								<div class="form-group" style="visibility: hidden;">
											...
											<select id="cat_change" name="sellerid" class="form-control">
												...
												<?php 
												$sn = mysqli_query($con,"select * from sellers_db");
												while($h = mysqli_fetch_assoc($sn))
												{
												?>
												<option value="<?php echo $h['id'];?>"><?php echo $h['s_name'];?></option>
												<?php } ?>
...
else 
{
	...
	$arr[] = "product/".$file_name;
		...
		$con->query("insert into product(`pname`,`pimg`,`prel`,`cid`,`sid`,`psdesc`,`pgms`,`pprice`,`date`,`status`,`stock`,`discount`,`popular`)values('".$pname."','".$url."','".$related."',".$catname.",".$subcatname.",'".$psdesc."','".$pgms."','".$pprice."','".$timestamp."',".$status.",".$ostock.",".$discount.",".$popular.")");
